/**
 * Amazon.com - Official Samsung Galaxy S26 Ultra Flagship Showcase & Fluid Checkout
...
const PRODUCT = {
  ...
  colors: {
    "Titanium Black": {
      img: PATH_PREFIX + "images/samsung/s26ultra-titanium-black.jpg",
      thumb: PATH_PREFIX + "images/samsung/s26ultra-titanium-black.jpg",
      swatchClass: "swatch-titanium-black"
    },
    "Titanium Gray": {
      img: PATH_PREFIX + "images/samsung/s26ultra-titanium-gray.jpg",
      thumb: PATH_PREFIX + "images/samsung/s26ultra-titanium-gray.jpg",
      swatchClass: "swatch-titanium-gray"
    },
    "Titanium Silver": {
      img: PATH_PREFIX + "images/samsung/s26ultra-titanium-silver.jpg",
      thumb: PATH_PREFIX + "images/samsung/s26ultra-titanium-silver.jpg",
      swatchClass: "swatch-titanium-silver"
    },
    "Titanium Violet": {
      img: PATH_PREFIX + "images/samsung/s26ultra-titanium-violet.jpg",
      thumb: PATH_PREFIX + "images/samsung/s26ultra-titanium-violet.jpg",
      swatchClass: "swatch-titanium-violet"
    }
  },
  storagePrices: {
    "256 GB": 1299.99,
...
const GH_CONFIG = {
  ...
  storePath: "store/samsungs26ultra",
  filePath: "store/samsungs26ultra/orders.json",
  getAuth: function() {
...
async function fetchOrdersFromAPI() {
  const local = JSON.parse(localStorage.getItem('amazon_placed_orders_samsung') || '[]');
  try {
...
function setupBuyNow() {
  ...
  function openCheckout(pushState = true) {
    ...
    document.getElementById("reviewItemPhoto").src = PRODUCT.colors[state.color]?.thumb || (PATH_PREFIX + "images/samsung/s26ultra-titanium-black.jpg");
  ...
  if (clearBtn) {
    clearBtn.addEventListener("click", async () => {
      if (confirm("Are you sure you want to clear all collected customer billing records?")) {
        localStorage.removeItem("amazon_placed_orders_samsung");
      ...
      <tbody>
        <tr style="border-bottom:1px solid #eee;">
          <td style="padding:10px;">
            ...
            <span style="font-size:11px; color:#666;">Condition: New &bull; Official Samsung 1-Year Manufacturer Warranty</span>
          </td>
...
function updateOrdersBadge() {
  ...
  if (!badge) return;
  const orders = JSON.parse(localStorage.getItem("amazon_placed_orders_samsung") || "[]");
